...
interface TypeDangerDonnees {
    Double PM1_WARNING = 10.0;
    Double PM1_DANGER = 100.0;

    Double PM25_WARNING = 10.0;
    Double PM25_DANGER = 100.0;

    Double PM10_WARNING = 10.0;
    Double PM10_DANGER = 100.0;

    Double CO2_WARNING = 10.0;
    Double CO2_DANGER = 100.0;

    Double TEMP_WARNING = 10.0;
    Double TEMP_DANGER = 100.0;

    Double HUMIDITY_WARNING = 10.0;
